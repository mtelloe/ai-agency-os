...
- [x] 02-04-PLAN.md — ApolloClient + shared withRetry helper (REQ-2.1, REQ-2.5)
- [x] 02-05-PLAN.md — HunterClient: findEmail + verifyEmail (REQ-2.2)
- [x] 02-06-PLAN.md — GmailClient: OAuth2 + base64url MIME send (REQ-2.3)
